...
if [ `getconf WORD_BIT` = '32' ] && [ `getconf LONG_BIT` = '64' ] ; then
 ...
 if ! wget -c --tries=3 http://centos.googlecode.com/files/ZendOptimizer-3.3.9-linux-glibc23-x86_64.tar.gz;then
 ...
 if ! wget -c --tries=3 http://centos.googlecode.com/files/ZendOptimizer-3.3.9-linux-glibc23-i386.tar.gz;then
...
\cp $cur_dir/conf/zend.ini /etc/php.d/zend.ini
